...
export function Join() {
  ...
  const handleEmailSubmit = async (e: React.FormEvent) => {
    ...
    const code = (form.querySelector("#j-code") as HTMLInputElement).value.trim().toUpperCase();
    const name = (form.querySelector("#j-name") as HTMLInputElement).value.trim();
    const email = (form.querySelector("#j-email") as HTMLInputElement).value.trim();
    try {
      await joinHome(email, password, name, code);
    } catch (e: any) {
        ...
        <div className="text-center mb-6 h-14 flex flex-col items-center justify-center">
          <AnimatePresence mode="wait">
            ...
            >
              {step === "options" ? (
                <>
                  <h1 className="text-2xl font-medium text-foreground">Join a home</h1>
                  <p className="text-sm text-muted-foreground mt-1">Connect with your partner's household</p>
                </>
              ) : (
                <>
                  <h1 className="text-2xl font-medium text-foreground">Join with email</h1>
                  <p className="text-sm text-muted-foreground mt-1">You'll need your partner's invite code</p>
                </>
              )}
            </motion.div>
          </AnimatePresence>
          ...
          {step === "options" && (
            ...
            >
              ...
              <p className="text-xs text-center text-muted-foreground px-2">
                Recommended — fastest way to join. You'll enter your invite code on the next screen.
              </p>
              ...
              <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} transition={spring}>
                <Button
                  ...
                  onClick={() => { setError(null); setStep("email-form"); }}
              ...
              <div className="pt-1">
                ...
                <div className="pt-4 text-center">
                  <p className="text-xs text-muted-foreground mb-2">Starting a new home instead?</p>
                  <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} transition={spring}>
                    <Button
                      variant="ghost"
                      size="sm"
            ...
            >
              <AnimatePresence mode="wait">
                {emailSent ? (
                  ...
                  >
                    ...
                    <div className="space-y-1">
                      ...
                      <p className="text-muted-foreground text-xs leading-relaxed">
                        We sent you a confirmation link. Click it, then come back to sign in — you'll already be in the household.
                      </p>
                    </div>
                    <motion.button
                  ...
                  <motion.form key="form" onSubmit={handleEmailSubmit} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        required
                      />
                      <p className="text-xs text-muted-foreground">This is how your partner will see you</p>
                    </div>
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="j-confirm">Confirm password</Label>
                      <div className="relative">
                        <Input
                          id="j-confirm"
                          type="password"
